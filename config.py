...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "5831968073:AAE5CP4gRFpCaFwH8SOLa09Du0vrJt0qWHo")
ADMINS = [int(i.strip()) for i in os.environ.get("ADMINS").split("1883570185")] if os.environ.get("ADMINS") else []
ADMIN = ADMINS
DATABASE_NAME = os.environ.get("DATABASE_NAME", "Cybuteheheuxu")
...
#  Optionnal variables
LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1001694641460")) 
